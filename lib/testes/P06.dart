...
class P06 extends StatefulWidget {
  String _codAluno;
  P06(this._codAluno);
  @override
  _P06State createState() => _P06State();
}

class _P06State extends State<P06> {
...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_np  = (_V01 + _V07 + _V08 + _V10 + _V12 + _V13 + _V15 + _V20 + _V29);
    score_im = (_V02 + _V03 + _V04 + _V16 + _V17 + _V19 + _V21 + _V22 + _V23 + _V25 + _V30);
    score_ic = (_V05 + _V06 + _V09 + _V11 + _V20 + _V24 + _V26 + _V28);
    ...
    db.collection("aluno")
        ...
        .add(
        {
          "Nao_Planejada" : score_np ,
          "Impuslividade_Motora" : score_im ,
          "Impulsividade_Cognitiva" : score_ic ,
          "Code":"D6","Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    ...
    "Eu tomo decisões sem pensar.",
    "Eu sou despreocupado.(Confio na Sorte)",
    "Eu não presto atenção..",
    "Eu tenho pensamentos que se atropelam",
    "Eu planejo viagens com bastante antecedência.",
    "Eu tenho autocontrole",
    "Eu me concentro facilmente.",
    "Eu economizo.(poupo)",
    "Eu fico me contorcendo na cadeira em peças de teatro ou palestras.",
    "Eu penso nas coisas com cuidado.",
    "Eu faço planos para me manter no emprego.",
    "Eu falo coisas sem pensar.",
    "Gosto de pensar em problemas complexos.",
    "Eu troco de emprego.",
    "Eu ajo por impulso.",
    "Eu fico entediado com facilidade quando estou resolvendo problemas mentalmente.",
    "Eu ajo no 'calor' do momento.",
    "Eu mantenho a linha de raciocínio ('não perco o fio da meada').",
    "Eu mudo de lugar com frequencia.",
    "Eu compro coisas por impulso.",
    "Só consigo pensar em uma coisa de cada vez.",
    "Eu troco de interesses e passatempos ('hobby').",
    "Eu gasto mais do que ganho.",
    "Enquanto estou pensando em uma coisa, é comum que outras ideias me venham à cabeça ou ao mesmo tempo.",
    "Estou mais interessado no presente do que no futuro.",
    "Eu me sinto inquieto em palestras ou aulas.",
    "Eu gosto de quebra-cabeças.",
    "Eu me preparo para o futuro.",
  ...
  _montaResultado() {
    if (
    (_npergunta == 1) |    (_npergunta == 7) |    (_npergunta == 8 )|    (_npergunta == 9 )|    (_npergunta == 10 )|    (_npergunta == 12 ) |
    (_npergunta == 13) |    (_npergunta == 15) |    (_npergunta == 20 )|    (_npergunta == 29 )|    (_npergunta == 30 ))
    {
      if      (_c1) { _resultado = 4;}
      else if (_c2) { _resultado = 3;}
      else if (_c3) { _resultado = 2;}
      else if (_c4) { _resultado = 1;}
...
//
  ...
  Widget build(BuildContext context) {
    ...
    //
    String item_1 = "RARAMENTE ou NUNCA";
    String item_2 = "OCASIONALMENTE";
    String item_3 = "MUITAS VEZES";
    String item_4 = "QUASE SEMPRE";
