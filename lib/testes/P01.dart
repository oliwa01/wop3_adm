...
import 'package:starbewebapp/resultados/Resultado_P01.dart';
...
*/
  ...
  void _gravaDb () {
    ...
    db.collection("aluno")
        ...
        .add(
        {
          "Auto_Estima" : score_auto_estima ,"Code":"D1","Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    ' ',
  'Na minha escola/trabalho, eu me ofereço frequntemente para ser voluntário(a).',
  'Mas eu seria uma escolha fraca para ....',
  'Dos meus passatempos desta lista, meu favorito é:',
  'Eu frequentemente me divirto ou aprecio muito ou quando assito....',
  'Quando eu vejo um filme, ou aspecto de que me lembro mais é....',
  ...
  'Meus hobbies/passatempo inclçuem....'
  ];
  bool _s1 = false;
  bool _c1 = false;
  bool _c2 = false;
