  ...
  void _gravaDb () {
    ...
    db.collection("aluno")
        ...
        .add(
        {
          ...
          "Code":"D2","Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    " ",
    "Eu me envergonho facilmente.",
    "Muitas vezes me sinto tão desamparado e desesperado que a vida se torna uma fonte de sofrimento para mim.",
    "Dormir mal é um dos meus maiores problemas.",
    "Costumo evitar conversar com pessoas em um trem ou em um ônibus.",
    "Eu costumo evitar sair.",
    "Costumo ter dor de cabeça.",
    "Costumo sentir vergonha.",
    "Sou muito nervoso.",
    "Costumo sentir tonturas.",
    "Às vezes, não consigo pensar em nada sem ser minhas preocupações.",
    "Eu raramente sinto dor no peito.",
    "Eu raramente me sinto tenso.",
    "Não consigo me concentrar em uma tarefa por causa da interrupção dos pensamentos.",
    "Eu raramente me sinto alegre.",
    "Tenho pensamentos perturbadores persistentes.",
    "Evito retornar a lugares onde já tive desconfortos ( lugares onde briguei, passei vergonha, fui roubado, etc.)",
    "Às vezes me considero uma pessoa ineficiente.",
    "Meus sentimentos dominam tanto minha personalidade que eu não tenho controle sobre eles.",
    "Eu me preocupo muito quando penso em uma possível desaprovação de outras.",
    "Costumo experimentar a sensação de excitação.",
    "Eu raramente tento evitar trabalhos desafiadores.",
    "Eu raramente durmo mal.",
    "Às vezes me sinto chateado.",
    "Sinto meus músculos tensos ao longo do dia.",
    "Quando em casa, procuro ficar sozinho à noite.",
    "Me sinto cansado quando meu trabalho é difícil.",
    "Raramente me preocupo com eventos sem importância.",
    "Eu raramente sorrio fácil.",
    "Normalmente, não me preocupo com as dificuldades da vida.",
    "Evito falar com meus superiores. (como o meus Pais ou Chefes).",
    "Eu raramente me perco com minhas preocupações.",
    "Independente de onde eu esteja ou o que eu faça, sempre sinto desconforto.",
    "Às vezes evito participar de discussões mesmo que eu conheça bem o tema.",
    "Minhas mãos raramente tremem.",
    "Às vezes me sinto extremamente constrangido.",
    "Estou preocupado que outros possam me interpretar mal.",
    "Ocasionalmente, sinto uma sensação de formigamento ao redor meu corpo.",
    "Eu raramente tento me afastar das reuniões sociais.",
    "Às vezes me sinto feliz, mas passa rápido.",
    "Mesmo que tudo esteja indo bem, minha mente está ocupada imaginando ideias perturbadoras",
    "Eu raramente tenho palpitações.",
    "Não consigo pensar claramente em nada, porque penso muitas coisas ao mesmo tempo.",
    "Parece haver um nó na garganta grande parte do tempo.",
    "Não consigo me sentir relaxado, mesmo sem ter nada pra fazer.",
    "Raramente evito falar em ocasiões sociais.",
    "Mesmo que seja necessário, evito perguntar coisas de outras pessoas.",
    "Eu raramente me imagino sendo impopular com meus amigos.",
    "Tenho diarreia uma vez por mês ou mais.",
    "Muitas vezes me pego pensando em possíveis situações embaraçosas.",
    "Eu geralmente me sinto bastante insegura em minha vida.",
    "Sinto uma forte pressão na nuca.",
    "Normalmente evito me envolver em atividades sociais.",
    "Meus sentimentos desagradáveis surgem a qualquer momento.",
    "Costumo tentar evitar andar em ruas movimentadas.",
    "Eu sempre me sinto irritado.",
    "Quase nunca conto piadas.",
    "Estou preocupado com a forma como os outros me veem.",
    "Às vezes, tenho problemas de estômago.",
    "Metade dos meus pensamentos está relacionada a alguns tipos de preocupação.",
    "Eu tento evitar enfrentar outras pessoas, mesmo que elas tirem vantagem de mim.",
