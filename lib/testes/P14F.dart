...
//
  ...
  var _pergunta = [
    ' ',
    "	Se eu estivesse doente, eu poderia depender de X para fazer o que fosse necessário.	",
    "	Se X pegou algo de valor emprestado e devolveu quebrado, X se ofereceria para pagar os reparos.	",
    " Se meu despertador estivesse quebrado e pedisse a X para me ligar no horario. eu poderia contar em receber a chamada.",
    "	Se X concordasse em alimentar meu animal de estimação enquanto eu estava fora, teria certeza que meu animal seria bem cuidado.	",
    ...
    "	Eu estaria disposto a emprestar X quase qualquer quantidade de dinheiro, porque me pagaria de volta, logo que Poderia.	",
    "	Se X não poderia se reunir comigo como tínhamos planejado, eu acreditaria em sua desculpa de que algo importante tinha chegado.	",
    "	Eu poderia falar livremente com X e saber que seria ouvido.	",
    "	X nunca intencionalmente deturpar meu ponto de visão para os outros.	",
    "	Se X soubesse que tipo de coisas feriram meus sentimentos, ele nunca iria usá-los contra mim, mesmo que nossa relação mudasse.	",
    "	Eu seria capaz de confiar em X e saber que ele/ela não discutiria minhas preocupações com os outros.	",
    "	Eu poderia esperar que X me dissesse a verdade.	",
