...
//
  ...
  var _pergunta = [
    ' ',
    "A presença de X torna qualquer atividade mais agradável.",
    "X está perto do meu ideal como pessoa.",
    "Tenho muita sorte de estar envolvido em um relacionamento com X.",
    "Eu me encontro querendo X quando não estamos juntos.",
    "Minha relação com X deu mais direção à minha vida e propósito.",
    "Eu passo mais tempo pensando na minha carreira do que eu sobre X.",
    "Eu ficaria extremamente deprimido por um longo tempo se meu relacionamento com X foram para acabar.",
    "Se eu não pudesse ter X, eu facilmente encontraria alguém para substituir X.",
    "Minha relação com X fez minha vida valer mais a pena.",
    "Eu realmente não preciso de X.",
    "Eu quero X.",
    "Sou muito dependente de X.",
    "Sinto-me muito orgulhoso de conhecer X.",
    "Eu quero que X confie plenamente em mim.",
    "Eu passo muito tempo pensando em X.",
    "Eu quero que X me diga 'Eu te amo'.",
    "Eu me sinto muito seguro na minha relação com X.",
    "X é uma pessoa bastante misteriosa.",
    "Muitas vezes me pergunto o quanto X realmente se importa comigo.",
    "Às vezes, eu gostaria de não me importar tanto com X.",
    "Eu me preocupo que X não se importa tanto comigo como eu faço com X.",
    "Tenho grande dificuldade em tentar descobrir X.",
    "Imaginei conversas que teria com X.",
    "Eu tento planejar o que eu quero dizer antes de falar com X.",
    "X presta atenção suficiente em mim.",
    "Eu me sinto desconfortável se X está fazendo amizade com alguém do sexo oposto.",
    "Preciso de X mais do que X precisa de mim.",
    "X tem sido a causa de algumas das minhas piores depressões.",
    "Minha relação com X é estável e silenciosamente satisfatória.",
    "Há pouco conflito entre X e eu.",
    "Eu me preocupo em perder o afeto de X."
