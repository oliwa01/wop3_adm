...
class GraficosP19 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP19State createState() => _GraficosP19State();

}

class _GraficosP19State extends State<GraficosP19> {
  ...
  _generateData() async {
    ...
    var data1 = [
      new Resultados(1, 'Compromisso ', widget.v1, widget.cv1),
      new Resultados(2, 'Controle', widget.v2, widget.cv2),
      new Resultados(3, 'Desafio', widget.v3, widget.cv3),
      new Resultados(4, 'TOTAL', widget.v4, widget.cv4),
      new Resultados(5, ' ', 160, Color(0xFFffffff).withOpacity(0.0)),
    ];
