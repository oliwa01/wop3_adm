...
class GraficosP15 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP15State createState() => _GraficosP15State();

}

class _GraficosP15State extends State<GraficosP15> {
  ...
  _generateData() async {
    ...
    var data1 = [
      new Resultados(1, 'Dependencia ', widget.v1, widget.cv1),
      new Resultados(2, 'Insegurança', widget.v2, widget.cv2),
