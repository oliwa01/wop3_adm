...
class GraficosP07 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  Color cv2;
  ...
  _GraficosP07State createState() => _GraficosP07State();

}

class _GraficosP07State extends State<GraficosP07> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Avaliação de Aparencia-MASC', widget.v1, widget.cv1),
      new Resultados(2, 'Avaliação de Aparencia-FEM', widget.v1, widget.cv2),
      new Resultados(3, 'Avaliação de Aptidão-MASC', widget.v2, widget.cv3),
      new Resultados(4, 'Avaliação de Aptidão-FEM', widget.v2, widget.cv4),
      new Resultados(5, 'Orientação Aparencia-MASC', widget.v3, widget.cv5),
      new Resultados(6, 'Orientação Aparencia-FEM', widget.v3, widget.cv6),
      new Resultados(7, 'Orientação Fitness-MASC', widget.v4, widget.cv7),
      new Resultados(8, 'Orientação Fitness-FEM', widget.v4, widget.cv8),
      new Resultados(9, 'Subjetivo-MASC', widget.v5, widget.cv9),
      new Resultados(10, 'Subjetivo-FEM', widget.v5, widget.cv10),
      new Resultados(11, 'Satisfação-MASC', widget.v6, widget.cv11),
      new Resultados(12, 'Satisfação-FEM', widget.v6, widget.cv12),
      new Resultados(13, ' ', 70, Color(0xFFffffff).withOpacity(0.0)),
    ];
                ...
                child: Container(
                  child: Center(
                    child: Column(
                      children: <Widget>[
                        Text(
                          'Relações Corpo-Auto Multidimencional',
