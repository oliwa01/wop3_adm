...
class GraficosP22 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;


  GraficosP22(this._codAluno,
      this.v1,
      this.cv1,
      );

  _GraficosP22State createState() => _GraficosP22State();

}

class _GraficosP22State extends State<GraficosP22> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Imortalidade', widget.v1, widget.cv1),
      new Resultados(3, ' ', 180, Color(0xFFffffff).withOpacity(0.0)),
