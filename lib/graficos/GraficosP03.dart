...
class GraficosP03 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;

  GraficosP03(this._codAluno,
      this.v1,
      this.cv1,
      );

  _GraficosP03State createState() => _GraficosP03State();

}

class _GraficosP03State extends State<GraficosP03> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'DEPRESSÃO', widget.v1, widget.cv1),
      new Resultados(3, ' ', 80, Color(0xFFffffff).withOpacity(0.0)),
    ];
    _seriesData.add(
      charts.Series(
