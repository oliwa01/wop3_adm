...
class GraficosP12 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;


  GraficosP12(this._codAluno,
      this.v1,
      this.cv1,
      );

  _GraficosP12State createState() => _GraficosP12State();

}

class _GraficosP12State extends State<GraficosP12> {
  ...
  _generateData() async {
    ...
    var data1 = [
      new Resultados(1, 'Escala de Vida ', widget.v1, widget.cv1),
      new Resultados(3, ' ', 20, Color(0xFFffffff).withOpacity(0.0)),
    ];
