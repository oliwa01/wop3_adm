...
class GraficosP04 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP04State createState() => _GraficosP04State();

}

class _GraficosP04State extends State<GraficosP04> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'ID', widget.v1, widget.cv1),
      new Resultados(2, 'LC', widget.v2, widget.cv2),
      new Resultados(3, 'OD', widget.v3, widget.cv3),
      new Resultados(4, 'PR', widget.v4, widget.cv4),
      new Resultados(5, ' ', 40, Color(0xFFffffff).withOpacity(0.0)),
