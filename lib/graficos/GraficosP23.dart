...
class GraficosP23 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  Color cv2;

  GraficosP23(this._codAluno,
      this.v1,
      this.cv1,
      this.cv2,
      );

  _GraficosP23State createState() => _GraficosP23State();

}

class _GraficosP23State extends State<GraficosP23> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Lidar com o Novo - Masculino', widget.v1, widget.cv1),
      new Resultados(2, 'Lidar com o Novo - Feminino', widget.v1, widget.cv2),
      new Resultados(3, ' ', 160, Color(0xFFffffff).withOpacity(0.0)),
    ];
