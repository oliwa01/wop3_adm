...
class GraficosP14 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP14State createState() => _GraficosP14State();

}

class _GraficosP14State extends State<GraficosP14> {
