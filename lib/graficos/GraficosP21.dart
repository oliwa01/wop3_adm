...
class GraficosP21 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  Color cv2;

  GraficosP21(this._codAluno,
      this.v1,
      this.cv1,
      this.cv2,
      );

  _GraficosP21State createState() => _GraficosP21State();

}

class _GraficosP21State extends State<GraficosP21> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Empatia - Masculino', widget.v1, widget.cv1),
      new Resultados(2, 'Empatia - Feminino', widget.v1, widget.cv2),
      new Resultados(3, ' ', 240, Color(0xFFffffff).withOpacity(0.0)),
    ];
