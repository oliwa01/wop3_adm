...
class GraficosP06 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP06State createState() => _GraficosP06State();

}

class _GraficosP06State extends State<GraficosP06> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'IMPLUSIVIDADE COGNITIVA', widget.v1, widget.cv1),
      new Resultados(2, 'IMPLUSIVIDADE MOTORA', widget.v2, widget.cv2),
      new Resultados(3, 'NÃO PLANEJADA', widget.v3, widget.cv3),
      new Resultados(5, 'TOTAL', widget.v4, widget.cv4),
      new Resultados(6, ' ', 80, Color(0xFFffffff).withOpacity(0.0)),
    ];
