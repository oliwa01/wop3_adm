...
class GraficosP18 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP18State createState() => _GraficosP18State();

}

class _GraficosP18State extends State<GraficosP18> {
  ...
  _generateData() async {
    ...
    var data1 = [
      new Resultados(1, 'Auto-eficácia Geral ', widget.v1, widget.cv1),
      new Resultados(2, 'Auto-eficácia Especifica', widget.v2, widget.cv2),
      new Resultados(3, ' ', 230, Color(0xFFffffff).withOpacity(0.0)),
    ];
