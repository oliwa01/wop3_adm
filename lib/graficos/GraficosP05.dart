...
class GraficosP05 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP05State createState() => _GraficosP05State();

}

class _GraficosP05State extends State<GraficosP05> {
  ...
  _generateData() async {
    ...
    var data1 = [
      new Resultados(1, 'AW', widget.v1, widget.cv1),
      new Resultados(2, 'SDS', widget.v2, widget.cv2),
      new Resultados(3, 'ODS', widget.v3, widget.cv3),
      new Resultados(4, 'LFT', widget.v4, widget.cv4),
      new Resultados(4, 'SW', widget.v5, widget.cv4),
      new Resultados(5, 'TOTAL', widget.v6, widget.cv5),
      new Resultados(6, ' ', 180, Color(0xFFffffff).withOpacity(0.0)),
    ];
