...
class GraficosP09 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP09State createState() => _GraficosP09State();

}

class _GraficosP09State extends State<GraficosP09> {
  ...
  _generateData() async {
    ...
    var data1 = [
      new Resultados(1, 'Auto-Conceito ', widget.v1, widget.cv1),
      new Resultados(2, 'Acessibilidade', widget.v2, widget.cv2),
      new Resultados(3, 'Gratificante', widget.v3, widget.cv3),
      new Resultados(4, 'Alienação', widget.v4, widget.cv4),
      new Resultados(5, 'TOTAL', widget.v5, widget.cv5),
      new Resultados(6, ' ', 140, Color(0xFFffffff).withOpacity(0.0)),
    ];
