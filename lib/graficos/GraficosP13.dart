...
class GraficosP13 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP13State createState() => _GraficosP13State();

}

class _GraficosP13State extends State<GraficosP13> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Excitação da Raiva ', widget.v1, widget.cv1),
      new Resultados(2, 'Provocação da Raiva ', widget.v2, widget.cv2),
      new Resultados(3, 'Hostilidade', widget.v3, widget.cv3),
      new Resultados(4, 'Raiva Externa', widget.v4, widget.cv4),
      new Resultados(5, 'Anger - In', widget.v5, widget.cv5),
      new Resultados(6, 'Total', widget.v6, widget.cv6),
      new Resultados(7, ' ', 180, Color(0xFFffffff).withOpacity(0.0)),
    ];
