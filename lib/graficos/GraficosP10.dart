...
class GraficosP10 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP10State createState() => _GraficosP10State();

}

class _GraficosP10State extends State<GraficosP10> {
  ...
  _generateData() async {
    ...
    var data1 = [
      ...
      new Resultados(3, ' ', 150, Color(0xFFffffff).withOpacity(0.0)),
    ];
