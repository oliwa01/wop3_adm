...
class GraficosP24 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  Color cv2;

  GraficosP24(this._codAluno,
      this.v1,
      this.cv1,
      this.cv2,
      );

  _GraficosP24State createState() => _GraficosP24State();

}

class _GraficosP24State extends State<GraficosP24> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Alegria - Masculino', widget.v1, widget.cv1),
      new Resultados(2, 'Alegria - Feminino', widget.v1, widget.cv2),
      new Resultados(3, ' ', 100, Color(0xFFffffff).withOpacity(0.0)),
    ];
