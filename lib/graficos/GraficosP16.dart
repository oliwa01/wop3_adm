...
class GraficosP16 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;

  GraficosP16(this._codAluno,
      this.v1,
      this.cv1,
      );

  _GraficosP16State createState() => _GraficosP16State();

}

class _GraficosP16State extends State<GraficosP16> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Culpa', widget.v1, widget.cv1),
      new Resultados(2, ' ', 230, Color(0xFFffffff).withOpacity(0.0)),
    ];
