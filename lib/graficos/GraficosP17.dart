...
class GraficosP17 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;

  GraficosP17(this._codAluno,
      this.v1,
      this.cv1,
      );

  _GraficosP17State createState() => _GraficosP17State();

}

class _GraficosP17State extends State<GraficosP17> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Humor Negativo', widget.v1, widget.cv1),
      new Resultados(3, ' ', 125, Color(0xFFffffff).withOpacity(0.0)),
    ];
