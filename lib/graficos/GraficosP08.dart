...
class GraficosP08 extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP08State createState() => _GraficosP08State();

}

class _GraficosP08State extends State<GraficosP08> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Preocupação Incerteza', widget.v1, widget.cv1),
      new Resultados(2, 'Preocupação Razões', widget.v2, widget.cv2),
    ];
