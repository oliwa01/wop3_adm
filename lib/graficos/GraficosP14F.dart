...
class GraficosP14F extends StatefulWidget {
  String _codAluno;
  int v1;
  Color cv1;
  int v2;
  ...
  _GraficosP14FState createState() => _GraficosP14FState();

}

class _GraficosP14FState extends State<GraficosP14F> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'Confiança Global', widget.v1, widget.cv1),
      new Resultados(2, 'Confiança Emocional', widget.v2, widget.cv2),
      new Resultados(3, 'Confiablilidade', widget.v3, widget.cv3),
      new Resultados(4, ' ', 100, Color(0xFFffffff).withOpacity(0.0)),
    ];
