...
class GraficosP02 extends StatefulWidget {
  String _codAluno;
  double v1;
  Color cv1;
  double v2;
  ...
  _GraficosP02State createState() => _GraficosP02State();

}

class _GraficosP02State extends State<GraficosP02> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, 'COGNITIVA', widget.v1, widget.cv1),
      new Resultados(2, 'COMPORTAMENTAL', widget.v2, widget.cv2),
      new Resultados(3, 'SENTIMENTO', widget.v3, widget.cv3),
      new Resultados(4, 'SOMÁTICA', widget.v4, widget.cv4),
