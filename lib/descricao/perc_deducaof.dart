...
class perc_deducaof extends StatefulWidget {
  String _codAluno;
  perc_deducaof(this._codAluno);
  @override
  _perc_deducaofState createState() => _perc_deducaofState();
}

class _perc_deducaofState extends State<perc_deducaof> {
  @override
