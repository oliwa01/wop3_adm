                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(
                            builder: (context) =>
                                GraficosDisc(widget._codAluno,widget._valD,widget._valI,widget._valS,widget._valC,widget._valDantes,widget._valIantes,widget._valSantes,widget._valCantes)));
                  },
                ),
              ),
            ),
